...
{\color{incolor}In [{\color{incolor}1}]:} \PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{datasets} \PY{k}{import} \PY{n}{load\PYZus{}files}       
        ...
        \PY{n}{train\PYZus{}files}\PY{p}{,} \PY{n}{train\PYZus{}targets} \PY{o}{=} \PY{n}{load\PYZus{}dataset}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{data/dogImages/train}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{valid\PYZus{}files}\PY{p}{,} \PY{n}{valid\PYZus{}targets} \PY{o}{=} \PY{n}{load\PYZus{}dataset}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{data/dogImages/valid}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{test\PYZus{}files}\PY{p}{,} \PY{n}{test\PYZus{}targets} \PY{o}{=} \PY{n}{load\PYZus{}dataset}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{data/dogImages/test}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} load list of dog names}
        \PY{n}{dog\PYZus{}names} \PY{o}{=} \PY{p}{[}\PY{n}{item}\PY{p}{[}\PY{l+m+mi}{20}\PY{p}{:}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]} \PY{k}{for} \PY{n}{item} \PY{o+ow}{in} \PY{n+nb}{sorted}\PY{p}{(}\PY{n}{glob}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{data/dogImages/train/*/}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{)}\PY{p}{]}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
C:\textbackslash{}Anaconda3\textbackslash{}envs\textbackslash{}bayes\textbackslash{}lib\textbackslash{}site-packages\textbackslash{}h5py\textbackslash{}\_\_init\_\_.py:36: FutureWarning: Conversion of the second argument of issubdtype from `float` to `np.floating` is deprecated. In future, it will be treated as `np.float64 == np.dtype(float).type`.
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{k+kn}{import} \PY{n+nn}{cv2}                
        ...
        \PY{n}{img} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{n}{human\PYZus{}files}\PY{p}{[}\PY{l+m+mi}{6}\PY{p}{]}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{human\PYZus{}files\PYZus{}short} \PY{o}{=} \PY{n}{human\PYZus{}files}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{100}\PY{p}{]}
        ...
        \PY{n+nb}{print}\PY{p}{(}\PY{n}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZob{}}\PY{l+s+s1}{100*np.array([face\PYZus{}detector(file) for file in human\PYZus{}files\PYZus{}short]).mean()\PYZcb{}}\PY{l+s+si}{\PYZpc{} o}\PY{l+s+s1}{f the human files flagged as having faces}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{n}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZob{}}\PY{l+s+s1}{100*np.array([face\PYZus{}detector(file) for file in dog\PYZus{}files\PYZus{}short]).mean()\PYZcb{}}\PY{l+s+si}{\PYZpc{} o}\PY{l+s+s1}{f the dog files were flagged as having faces}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
As we'll see in our application later, this approach to human detection
leads to many false negatives. We can also see just from the calculation
above that this approach would also lead to false positives for roughly
12\% of dogs. So, no I wouldn't say that this is a very robust method
for human detection.

One simple alternative would be to take advantage of the other classes
that available from imagenet. In addition to all of the dogs, there
classes which correspond to pictures with people in them which. We would
then probably want to mine a simple dataset containing people and dogs
which the model distinguishes between the two fo them.
...
{\color{incolor}In [{\color{incolor}12}]:} \PY{k+kn}{from} \PY{n+nn}{keras}\PY{n+nn}{.}\PY{n+nn}{preprocessing} \PY{k}{import} \PY{n}{image}                  
         \PY{k+kn}{from} \PY{n+nn}{tqdm} \PY{k}{import} \PY{n}{tqdm\PYZus{}no}
...
\textbf{Answer:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{n+nb}{print}\PY{p}{(}\PY{n}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{ Humans with dog detected: }\PY{l+s+s1}{\PYZob{}}\PY{l+s+s1}{np.array([dog\PYZus{}detector(human) for human in human\PYZus{}files\PYZus{}short]).mean()\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{ Dogs with dog detected: }\PY{l+s+s1}{\PYZob{}}\PY{l+s+s1}{np.array([dog\PYZus{}detector(dog) for dog in dog\PYZus{}files\PYZus{}short]).mean()\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
100\%|█████████████████████████████████████████████████████████| 6680/6680 [00:48<00:00, 138.81it/s]
100\%|███████████████████████████████████████████████████████████| 835/835 [00:05<00:00, 152.73it/s]
100\%|███████████████████████████████████████████████████████████| 836/836 [00:05<00:00, 155.97it/s]
...
\textbf{Answer:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}34}]:} \PY{k+kn}{from} \PY{n+nn}{keras}\PY{n+nn}{.}\PY{n+nn}{layers} \PY{k}{import} \PY{n}{Conv2D}\PY{p}{,} \PY{n}{MaxPooling2D}\PY{p}{,} \PY{n}{GlobalAveragePooling2D}\PY{p}{,} \PY{n}{Activation}
         ...
         \PY{k}{def} \PY{n+nf}{conv\PYZus{}block}\PY{p}{(}\PY{n}{model}\PY{p}{,} \PY{n}{filters}\PY{p}{,} \PY{n}{kernel}\PY{p}{,} \PY{n}{dropout}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{,} \PY{n}{input\PYZus{}shape}\PY{o}{=}\PY{k+kc}{None}\PY{p}{)}\PY{p}{:}
             \PY{k}{if} \PY{n}{input\PYZus{}shape} \PY{o+ow}{is} \PY{o+ow}{not} \PY{k+kc}{None}\PY{p}{:}
                 \PY{n}{model}\PY{o}{.}\PY{n}{add}\PY{p}{(}\PY{n}{Conv2D}\PY{p}{(}\PY{n}{filters}\PY{o}{=}\PY{n}{filters}\PY{p}{,} 
                          \PY{n}{kernel\PYZus{}size}\PY{o}{=}\PY{n}{kernel}\PY{p}{,}
                          \PY{n}{strides}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,}
         ...
         \PY{n}{model} \PY{o}{=} \PY{n}{conv\PYZus{}block}\PY{p}{(}\PY{n}{model}\PY{p}{,} \PY{l+m+mi}{32}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{,} \PY{n}{dropout}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{,} \PY{n}{input\PYZus{}shape}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{224}\PY{p}{,} \PY{l+m+mi}{224}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{)}\PY{p}{)}
         \PY{n}{model} \PY{o}{=} \PY{n}{conv\PYZus{}block}\PY{p}{(}\PY{n}{model}\PY{p}{,} \PY{l+m+mi}{64}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{,} \PY{n}{dropout}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}
         \PY{n}{model} \PY{o}{=} \PY{n}{conv\PYZus{}block}\PY{p}{(}\PY{n}{model}\PY{p}{,} \PY{l+m+mi}{128}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{,} \PY{n}{dropout}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}
...
=================================================================
conv2d\_16 (Conv2D)           (None, 224, 224, 32)      896       
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
dropout\_13 (Dropout)         (None, 224, 224, 32)      0         
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
max\_pooling2d\_18 (MaxPooling (None, 112, 112, 32)      0         
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
conv2d\_17 (Conv2D)           (None, 112, 112, 64)      18496     
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
dropout\_14 (Dropout)         (None, 112, 112, 64)      0         
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
max\_pooling2d\_19 (MaxPooling (None, 56, 56, 64)        0         
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
conv2d\_18 (Conv2D)           (None, 56, 56, 128)       73856     
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
dropout\_15 (Dropout)         (None, 56, 56, 128)       0         
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
max\_pooling2d\_20 (MaxPooling (None, 28, 28, 128)       0         
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
global\_average\_pooling2d\_6 ( (None, 128)               0         
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
dense\_6 (Dense)              (None, 133)               17157     
=================================================================
...
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}35}]:} \PY{n}{model}\PY{o}{.}\PY{n}{compile}\PY{p}{(}\PY{n}{optimizer}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{rmsprop}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} 
...
the training data}, but this is not a requirement.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}36}]:} \PY{k+kn}{from} \PY{n+nn}{keras}\PY{n+nn}{.}\PY{n+nn}{preprocessing} \PY{k}{import} \PY{n}{image}                  
...
Epoch 1/5
6680/6680 [==============================] - 20s 3ms/step - loss: 4.8654 - acc: 0.0115 - val\_loss: 4.8197 - val\_acc: 0.0144

Epoch 00001: val\_loss improved from inf to 4.81968, saving model to saved\_models/weights.best.from\_scratch.hdf5
Epoch 2/5
6680/6680 [==============================] - 18s 3ms/step - loss: 4.8236 - acc: 0.0168 - val\_loss: 4.8162 - val\_acc: 0.0168

Epoch 00002: val\_loss improved from 4.81968 to 4.81619, saving model to saved\_models/weights.best.from\_scratch.hdf5
Epoch 3/5
6680/6680 [==============================] - 18s 3ms/step - loss: 4.8103 - acc: 0.0189 - val\_loss: 4.8239 - val\_acc: 0.0216

Epoch 00003: val\_loss did not improve from 4.81619
Epoch 4/5
6680/6680 [==============================] - 18s 3ms/step - loss: 4.8038 - acc: 0.0211 - val\_loss: 4.8052 - val\_acc: 0.0120

Epoch 00004: val\_loss improved from 4.81619 to 4.80518, saving model to saved\_models/weights.best.from\_scratch.hdf5
Epoch 5/5
6680/6680 [==============================] - 18s 3ms/step - loss: 4.7939 - acc: 0.0201 - val\_loss: 4.8500 - val\_acc: 0.0192

Epoch 00005: val\_loss did not improve from 4.80518

    \end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}36}]:} <keras.callbacks.History at 0x24b4bedb160>
\end{Verbatim}
...
Loss}\label{load-the-model-with-the-best-validation-loss}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}37}]:} \PY{n}{model}\PY{o}{.}\PY{n}{load\PYZus{}weights}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{saved\PYZus{}models/weights.best.from\PYZus{}scratch.hdf5}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
test accuracy is greater than 1\%.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}38}]:} \PY{c+c1}{\PYZsh{} get index of predicted dog breed for each image in test set}
...
Features}\label{obtain-bottleneck-features}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}39}]:} \PY{n}{bottleneck\PYZus{}features} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{load}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{bottleneck\PYZus{}features/DogVGG16Data.npz}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
category and is equipped with a softmax.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}40}]:} \PY{n}{VGG16\PYZus{}model} \PY{o}{=} \PY{n}{Sequential}\PY{p}{(}\PY{p}{)}
...
Train on 6680 samples, validate on 835 samples
Epoch 1/20
6680/6680 [==============================] - 2s 373us/step - loss: 11.9204 - acc: 0.1198 - val\_loss: 10.3121 - val\_acc: 0.2012

Epoch 00001: val\_loss improved from inf to 10.31208, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 2/20
6680/6680 [==============================] - 2s 289us/step - loss: 9.1305 - acc: 0.3037 - val\_loss: 9.1593 - val\_acc: 0.2946

Epoch 00002: val\_loss improved from 10.31208 to 9.15926, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 3/20
6680/6680 [==============================] - 2s 293us/step - loss: 8.1970 - acc: 0.3963 - val\_loss: 8.6838 - val\_acc: 0.3389

Epoch 00003: val\_loss improved from 9.15926 to 8.68378, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 4/20
6680/6680 [==============================] - 2s 283us/step - loss: 7.8819 - acc: 0.4466 - val\_loss: 8.5617 - val\_acc: 0.3641

Epoch 00004: val\_loss improved from 8.68378 to 8.56167, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 5/20
6680/6680 [==============================] - 2s 285us/step - loss: 7.6583 - acc: 0.4723 - val\_loss: 8.3046 - val\_acc: 0.3880

Epoch 00005: val\_loss improved from 8.56167 to 8.30464, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 6/20
6680/6680 [==============================] - 2s 285us/step - loss: 7.3358 - acc: 0.5007 - val\_loss: 8.0312 - val\_acc: 0.3988

Epoch 00006: val\_loss improved from 8.30464 to 8.03117, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 7/20
6680/6680 [==============================] - 2s 295us/step - loss: 7.1459 - acc: 0.5208 - val\_loss: 7.8743 - val\_acc: 0.4120

Epoch 00007: val\_loss improved from 8.03117 to 7.87425, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 8/20
6680/6680 [==============================] - 2s 296us/step - loss: 6.9480 - acc: 0.5317 - val\_loss: 7.6189 - val\_acc: 0.4192

Epoch 00008: val\_loss improved from 7.87425 to 7.61891, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 9/20
6680/6680 [==============================] - 2s 289us/step - loss: 6.6541 - acc: 0.5534 - val\_loss: 7.4957 - val\_acc: 0.4383

Epoch 00009: val\_loss improved from 7.61891 to 7.49566, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 10/20
6680/6680 [==============================] - 2s 282us/step - loss: 6.5090 - acc: 0.5707 - val\_loss: 7.4585 - val\_acc: 0.4407

Epoch 00010: val\_loss improved from 7.49566 to 7.45853, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 11/20
6680/6680 [==============================] - 2s 285us/step - loss: 6.4509 - acc: 0.5835 - val\_loss: 7.3716 - val\_acc: 0.4623

Epoch 00011: val\_loss improved from 7.45853 to 7.37157, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 12/20
6680/6680 [==============================] - 2s 295us/step - loss: 6.3740 - acc: 0.5871 - val\_loss: 7.2967 - val\_acc: 0.4527

Epoch 00012: val\_loss improved from 7.37157 to 7.29670, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 13/20
6680/6680 [==============================] - 2s 295us/step - loss: 6.2958 - acc: 0.5966 - val\_loss: 7.2694 - val\_acc: 0.4635

Epoch 00013: val\_loss improved from 7.29670 to 7.26943, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 14/20
6680/6680 [==============================] - 2s 295us/step - loss: 6.2400 - acc: 0.5985 - val\_loss: 7.3440 - val\_acc: 0.4515

Epoch 00014: val\_loss did not improve from 7.26943
Epoch 15/20
6680/6680 [==============================] - 2s 300us/step - loss: 6.1138 - acc: 0.6069 - val\_loss: 7.1611 - val\_acc: 0.4599

Epoch 00015: val\_loss improved from 7.26943 to 7.16107, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 16/20
6680/6680 [==============================] - 2s 294us/step - loss: 5.9762 - acc: 0.6133 - val\_loss: 6.9988 - val\_acc: 0.4814

Epoch 00016: val\_loss improved from 7.16107 to 6.99883, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 17/20
6680/6680 [==============================] - 2s 347us/step - loss: 5.8271 - acc: 0.6208 - val\_loss: 6.9055 - val\_acc: 0.4826

Epoch 00017: val\_loss improved from 6.99883 to 6.90549, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 18/20
6680/6680 [==============================] - 2s 309us/step - loss: 5.5291 - acc: 0.6316 - val\_loss: 6.6867 - val\_acc: 0.4814

Epoch 00018: val\_loss improved from 6.90549 to 6.68670, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 19/20
6680/6680 [==============================] - 2s 282us/step - loss: 5.3333 - acc: 0.6484 - val\_loss: 6.5240 - val\_acc: 0.4910

Epoch 00019: val\_loss improved from 6.68670 to 6.52397, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 20/20
6680/6680 [==============================] - 2s 296us/step - loss: 5.1972 - acc: 0.6581 - val\_loss: 6.4539 - val\_acc: 0.5066

Epoch 00020: val\_loss improved from 6.52397 to 6.45387, saving model to saved\_models/weights.best.VGG16.hdf5

    \end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}26}]:} <keras.callbacks.History at 0x1c5483b6358>
\end{Verbatim}
...
\end{verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}42}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Obtain bottleneck features from another pre\PYZhy{}trained CNN.}
         
         \PY{k}{def} \PY{n+nf}{extract\PYZus{}res50\PYZus{}features}\PY{p}{(}\PY{p}{)}\PY{p}{:}
             ...
             \PY{n}{train\PYZus{}Res50} \PY{o}{=} \PY{n}{bottleneck\PYZus{}features}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{train}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
             \PY{n}{valid\PYZus{}Res50} \PY{o}{=} \PY{n}{bottleneck\PYZus{}features}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{valid}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
             \PY{n}{test\PYZus{}Res50} \PY{o}{=} \PY{n}{bottleneck\PYZus{}features}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
             \PY{k}{return} \PY{n}{train\PYZus{}Res50}\PY{p}{,} \PY{n}{valid\PYZus{}Res50}\PY{p}{,} \PY{n}{test\PYZus{}Res50}
         \PY{n}{train\PYZus{}Res50}\PY{p}{,} \PY{n}{valid\PYZus{}Res50}\PY{p}{,} \PY{n}{test\PYZus{}Res50} \PY{o}{=} \PY{n}{extract\PYZus{}res50\PYZus{}features}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer:} We didn't go much beyond the example, as it's really
not necessary thanks to the bottleneck features. The only differnce was
adding one addition fully-connected layer with a large number of units
to allow for it to find interesting mappings from the bottleneck
features. We then added a dropout layer as a form of regularization to
help prevent overfitting.

This model gets \textasciitilde{}80\% on the test set, which exceeds to
the required accuracy and is pretty good for a 'out of the can' type of
model.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}55}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Define your architecture.}
         \PY{n}{Res50\PYZus{}model} \PY{o}{=} \PY{n}{Sequential}\PY{p}{(}\PY{p}{)}
         \PY{n}{Res50\PYZus{}model}\PY{o}{.}\PY{n}{add}\PY{p}{(}\PY{n}{GlobalAveragePooling2D}\PY{p}{(}\PY{n}{input\PYZus{}shape}\PY{o}{=}\PY{n}{train\PYZus{}Res50}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         \PY{n}{Res50\PYZus{}model}\PY{o}{.}\PY{n}{add}\PY{p}{(}\PY{n}{Dense}\PY{p}{(}\PY{l+m+mi}{500}\PY{p}{,} \PY{n}{activation}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{relu}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
         \PY{n}{Res50\PYZus{}model}\PY{o}{.}\PY{n}{add}\PY{p}{(}\PY{n}{Dropout}\PY{p}{(}\PY{l+m+mf}{0.3}\PY{p}{)}\PY{p}{)}
         \PY{n}{Res50\PYZus{}model}\PY{o}{.}\PY{n}{add}\PY{p}{(}\PY{n}{Dense}\PY{p}{(}\PY{l+m+mi}{133}\PY{p}{,} \PY{n}{activation}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{softmax}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
         
         \PY{n}{Res50\PYZus{}model}\PY{o}{.}\PY{n}{summary}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
Layer (type)                 Output Shape              Param \#   
=================================================================
global\_average\_pooling2d\_11  (None, 2048)              0         
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
dense\_13 (Dense)             (None, 500)               1024500   
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
dropout\_18 (Dropout)         (None, 500)               0         
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
dense\_14 (Dense)             (None, 133)               66633     
=================================================================
...
Model}\label{implementation-compile-the-model}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}56}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Compile the model.}
         \PY{n}{Res50\PYZus{}model}\PY{o}{.}\PY{n}{compile}\PY{p}{(}\PY{n}{loss}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{categorical\PYZus{}crossentropy}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{optimizer}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{rmsprop}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{metrics}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{accuracy}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
...
the training data}, but this is not a requirement.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}58}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Train the model.}
         \PY{n}{checkpointer} \PY{o}{=} \PY{n}{ModelCheckpoint}\PY{p}{(}\PY{n}{filepath}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{saved\PYZus{}models/weights.best.Res50.hdf5}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} 
                                        \PY{n}{verbose}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{save\PYZus{}best\PYZus{}only}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
         
         \PY{n}{Res50\PYZus{}model}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{train\PYZus{}Res50}\PY{p}{,} \PY{n}{train\PYZus{}targets}\PY{p}{,} 
                   \PY{n}{validation\PYZus{}data}\PY{o}{=}\PY{p}{(}\PY{n}{valid\PYZus{}Res50}\PY{p}{,} \PY{n}{valid\PYZus{}targets}\PY{p}{)}\PY{p}{,}
                   \PY{n}{epochs}\PY{o}{=}\PY{l+m+mi}{5}\PY{p}{,} \PY{n}{batch\PYZus{}size}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,} \PY{n}{callbacks}\PY{o}{=}\PY{p}{[}\PY{n}{checkpointer}\PY{p}{]}\PY{p}{,} \PY{n}{verbose}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
\end{Verbatim}
...
Train on 6680 samples, validate on 835 samples
Epoch 1/5
6680/6680 [==============================] - 2s 307us/step - loss: 0.5714 - acc: 0.8175 - val\_loss: 0.7549 - val\_acc: 0.8012

Epoch 00001: val\_loss improved from inf to 0.75491, saving model to saved\_models/weights.best.Res50.hdf5
Epoch 2/5
6680/6680 [==============================] - 2s 297us/step - loss: 0.4475 - acc: 0.8596 - val\_loss: 0.7498 - val\_acc: 0.7988

Epoch 00002: val\_loss improved from 0.75491 to 0.74979, saving model to saved\_models/weights.best.Res50.hdf5
Epoch 3/5
6680/6680 [==============================] - 2s 291us/step - loss: 0.3507 - acc: 0.8861 - val\_loss: 0.7399 - val\_acc: 0.8048

Epoch 00003: val\_loss improved from 0.74979 to 0.73993, saving model to saved\_models/weights.best.Res50.hdf5
Epoch 4/5
6680/6680 [==============================] - 2s 297us/step - loss: 0.3050 - acc: 0.9049 - val\_loss: 0.7919 - val\_acc: 0.8048

Epoch 00004: val\_loss did not improve from 0.73993
Epoch 5/5
6680/6680 [==============================] - 2s 286us/step - loss: 0.2626 - acc: 0.9178 - val\_loss: 0.8100 - val\_acc: 0.8048

Epoch 00005: val\_loss did not improve from 0.73993

    \end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}58}]:} <keras.callbacks.History at 0x24b4b986eb8>
\end{Verbatim}
...
Loss}\label{implementation-load-the-model-with-the-best-validation-loss}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}59}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Load the model weights with the best validation loss.}
         \PY{n}{Res50\PYZus{}model}\PY{o}{.}\PY{n}{load\PYZus{}weights}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{saved\PYZus{}models/weights.best.Res50.hdf5}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
test accuracy is greater than 60\%.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}60}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Calculate classification accuracy on the test dataset.}
         \PY{c+c1}{\PYZsh{} get index of predicted dog breed for each image in test set}
         \PY{n}{Res50\PYZus{}predictions} \PY{o}{=} \PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{argmax}\PY{p}{(}\PY{n}{Res50\PYZus{}model}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{expand\PYZus{}dims}\PY{p}{(}\PY{n}{feature}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{)}\PY{p}{)} \PY{k}{for} \PY{n}{feature} \PY{o+ow}{in} \PY{n}{test\PYZus{}Res50}\PY{p}{]}
         
         \PY{c+c1}{\PYZsh{} report test accuracy}
         \PY{n}{test\PYZus{}accuracy} \PY{o}{=} \PY{l+m+mi}{100}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{Res50\PYZus{}predictions}\PY{p}{)}\PY{o}{==}\PY{n}{np}\PY{o}{.}\PY{n}{argmax}\PY{p}{(}\PY{n}{test\PYZus{}targets}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}\PY{o}{/}\PY{n+nb}{len}\PY{p}{(}\PY{n}{Res50\PYZus{}predictions}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Test accuracy: }\PY{l+s+si}{\PYZpc{}.4f}\PY{l+s+si}{\PYZpc{}\PYZpc{}}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}} \PY{n}{test\PYZus{}accuracy}\PY{p}{)}
\end{Verbatim}
...
\texttt{Xception}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}61}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Write a function that takes a path to an image as input}
         ...
         \PY{k}{def} \PY{n+nf}{Res50\PYZus{}predict\PYZus{}breed}\PY{p}{(}\PY{n}{img\PYZus{}path}\PY{p}{)}\PY{p}{:}
             \PY{c+c1}{\PYZsh{} extract bottleneck features}
             ...
             \PY{c+c1}{\PYZsh{} obtain predicted vector}
             \PY{n}{predicted\PYZus{}vector} \PY{o}{=} \PY{n}{Res50\PYZus{}model}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{bottleneck\PYZus{}feature}\PY{p}{)}
             \PY{c+c1}{\PYZsh{} return dog breed that is predicted by the model}
             \PY{k}{return} \PY{n}{dog\PYZus{}names}\PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{argmax}\PY{p}{(}\PY{n}{predicted\PYZus{}vector}\PY{p}{)}\PY{p}{]}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}62}]:} \PY{k}{for} \PY{n}{file} \PY{o+ow}{in} \PY{n}{human\PYZus{}files\PYZus{}short}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{5}\PY{p}{]}\PY{p}{:}
             \PY{n+nb}{print}\PY{p}{(}\PY{n}{Res50\PYZus{}predict\PYZus{}breed}\PY{p}{(}\PY{n}{file}\PY{p}{)}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
\textbackslash{}004.Akita
\textbackslash{}097.Lakeland\_terrier
\textbackslash{}132.Xoloitzcuintli
\textbackslash{}014.Basenji
\textbackslash{}009.American\_water\_spaniel
...
Algorithm}\label{implementation-write-your-algorithm}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}63}]:} \PY{k}{def} \PY{n+nf}{Res50\PYZus{}predict\PYZus{}breed}\PY{p}{(}\PY{n}{img\PYZus{}path}\PY{p}{)}\PY{p}{:}
             \PY{c+c1}{\PYZsh{} Use our dog and face detector to determine if our}
             \PY{c+c1}{\PYZsh{} input is human or a dog.  The face (human) detector}
             \PY{c+c1}{\PYZsh{} is more prone to false positives, so we use it second. }
             ...
             \PY{k}{else}\PY{p}{:}
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{hello, alien creature!}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             \PY{c+c1}{\PYZsh{} load color (BGR) image}
             \PY{n}{img} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{n}{img\PYZus{}path}\PY{p}{)}
             ...
             \PY{n}{predicted\PYZus{}vector} \PY{o}{=} \PY{n}{Res50\PYZus{}model}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{bottleneck\PYZus{}feature}\PY{p}{)}
             \PY{c+c1}{\PYZsh{} return dog breed that is predicted by the model}
             \PY{n}{name} \PY{o}{=} \PY{n}{dog\PYZus{}names}\PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{argmax}\PY{p}{(}\PY{n}{predicted\PYZus{}vector}\PY{p}{)}\PY{p}{]}
...
\textbf{Answer:} The real weakness in the application currently is the
human detector. As we can see from the example first set of example
humans, we can easily identify a human \emph{if} their face is the focus
of the shot. However if the picture contains more than that, say as in
the picture of the woman with a python at the bottom, we notice that it
fails to identify the subject as human. So, the first improvement would
be a proper human detector that might use deep learning instead of the
face detector we are currently using.

I was quite happy with the dog breed model. It correctly identified the
two breeds in the pictures I provided. Accounting for mixed breeds would
be smart for this particular aspect of the applicaiton.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}65}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} TODO: Execute your algorithm from Step 6 on}
         \PY{c+c1}{\PYZsh{}\PYZsh{} at least 6 images on your computer.}
         \PY{c+c1}{\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
         \PY{k}{for} \PY{n}{imfile} \PY{o+ow}{in} \PY{n}{human\PYZus{}files\PYZus{}short}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{5}\PY{p}{]}\PY{p}{:}
             \PY{n}{Res50\PYZus{}predict\PYZus{}breed}\PY{p}{(}\PY{n}{imfile}\PY{p}{)}
\end{Verbatim}
...
\textbackslash{}127.Silky\_terrier
hello, human!
...
\textbackslash{}127.Silky\_terrier
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}65}]:} \PY{k}{for} \PY{n}{imfile} \PY{o+ow}{in} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{glob}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{data/test/*}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{)}\PY{p}{:}
             \PY{n}{Res50\PYZus{}predict\PYZus{}breed}\PY{p}{(}\PY{n}{imfile}\PY{p}{)}
\end{Verbatim}
...
hello, human!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
You look like a {\ldots}
\textbackslash{}017.Bearded\_collie
hello, dog!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
You look like a {\ldots}
\textbackslash{}006.American\_eskimo\_dog
...
hello, alien creature!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
You look like a {\ldots}
\textbackslash{}112.Nova\_scotia\_duck\_tolling\_retriever
hello, dog!
